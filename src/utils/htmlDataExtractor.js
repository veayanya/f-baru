...
function scrapeSroi(dom) {
 ...
 qText(c, '.stat-label').toLowerCase().includes(label.toLowerCase())
 );
...
function scrapeAnalysisDocument(dom, htmlText, warnings) {
 ...
 warnings.push(`Rasio SROI hasil hitung ulang (${calc.sroiScore}) berbeda dari HTML (${sroi.sroiRatio}).`);
 }
