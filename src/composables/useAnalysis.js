...
const state = reactive({
  ...
  rules: JSON.parse(localStorage.getItem('bapperida_rules')) || [
    { id: 'rule-sroi-min', name: 'Ambang Batas Rasio SROI Minimal', desc: 'Nilai rasio manfaat sosial-ekonomi (SROI) ≥ 1.0 dinyatakan Layak (Hijau), sedangkan 0.6 – 0.99 diberikan Keringanan/Moderat (Kuning).', active: true },
