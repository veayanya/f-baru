<template>
 ...
 <span style="color: #64748b;">SROI Saat Ini:</span>
 ...
 <span class="sroi-ratio-eyebrow">Rasio SROI (Social Return on Investment)</span>
 ...
 <div class="sroi-ratio-formula">SROI Ratio = Present Value (PV) of Impact ÷ Value of Inputs</div>
 ...
 <div class="stat-label">Value of Inputs (Pagu)</div>
 ...
 <div class="sroi-stat-card">
 <div class="stat-label">Present Value (PV) Dampak</div>
 ...
 <div class="step-body">
 <div class="step-title">Value of Inputs</div>
 ...
 <div class="step-body">
 <div class="step-title">SROI Ratio</div>
 ...
 <div class="rka-section">
 <div class="rka-section-title"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" style="vertical-align:middle;margin-right:8px;flex-shrink:0;"><path d="M21.21 15.89A10 10 0 118 2.83" stroke="#1B4D46" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M22 12A10 10 0 0012 2v10z" stroke="#1B4D46" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg> Ringkasan Efektif &amp; Inefektif per Rekening</div>
 ...
 <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" style="vertical-align:middle;margin-right:5px;"><circle cx="12" cy="12" r="9" stroke="#22c55e" stroke-width="2"/><path d="M8 12l3 3 5-5" stroke="#22c55e" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg> Efektif
 </div>
 ...
 <div class="efektivitas-col-header">
 <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" style="vertical-align:middle;margin-right:5px;"><circle cx="12" cy="12" r="9" stroke="#ef4444" stroke-width="2"/><path d="M9 9l6 6M15 9l-6 6" stroke="#ef4444" stroke-width="2" stroke-linecap="round"/></svg> Tidak Efektif / Perlu Perhatian
 </div>
...
const { currentTab, rkis, openInAgenticAi, loadSpecificVersionIntoAnalyzer, loadHistoricalDocIntoAnalyzer, reanalyzeDocWithPdf, saveRki, deleteRki } = useAnalysis();
